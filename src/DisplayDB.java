...
<<<<<<< HEAD
   public void showTableDataP()
   {
	   ...
	   String lastScore;
	   String playerRank;
	   String[] teamColumnNames = {"Player ID", "First Name", "Last Name", "Last Score", "Player Rank"};
	   ...
	   try {
			...
			while(rset.next())	{
				...
				lastScore = rset.getString("lastscore"); 
				playerRank = rset.getString("playerRank");
				model.addRow(new Object[]{playerId, FName, LName, lastScore, playerRank});
			}
	   }	catch(Exception ex)
	   		{
